...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/home/amy/code/depth-estimation/Monocular-Depth-Estimation-Toolbox/configs/simipu/simclr-r50-imagenet-standard.pth'
        )),
    decode_head=dict(
        type='DenseDepthHead',
...
work_dir = './saves/SimIPU/simclr_nyu_freeze_1'
gpu_ids = range(0, 1)
